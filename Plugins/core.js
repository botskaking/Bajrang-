    ...
    switch (inputCMD) {
      ...
      case "sc":
        ...
        let repoInfo = await axios.get(
          "https://api.github.com/repos/botskaking/Bajrang-"
        );
        ...
        let txt = `            🧣 *${botName}'s Script* 🧣\n\n*🎀 Total Forks:* ${
          ...
          repo.html_url
        }\n\n❝ Dont forget to give a Star ⭐ to the repo. It's made with restless hardwork by *Team T R I D E N T  B O T Z
        *. ❞\n\n*©️ Team T R I D E N T B O T Z  - 2024*`;
      ...
      case "about":
        ...
        let xyz = await axios.get(
          "https://api.github.com/repos/botskaking/Bajrang-/releases"
        );
